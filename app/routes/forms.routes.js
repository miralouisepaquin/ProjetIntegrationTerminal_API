...
/** Swagger post /api/forms/createForm/
 * @swagger
...
/** Swagger get /api/forms/findAllForms
 * @swagger
  * /api/forms/findAllForms/:
  *  get:
...
/** Swagger get /api/forms/findForm/:identifiant
 * @swagger
 * /api/forms/findForm/{identifiant}:
 *   get:
...
/** Swagger put /api/forms/updateForm/:id
 * @swagger
 * /api/forms/updateForm/{id}:
 *   put:
...
/** Swagger delete /api/forms/deleteForm/:id
 * @swagger
